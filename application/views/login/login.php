...
<head>
    ...
    />
    <meta name="description" content="Bootstrap 4 Dashboard Template">
                                ...
                                <div class="modal-content">
                                    <div class="modal-body">
                                        ...
                                        <form class="" action="<?php echo site_url('login/login');?>" method="post">
                                            <div class="form-row">
                                                <div class="col-md-12">
                                                    <div class="position-relative form-group"><input name="nipd" id="exampleEmail" placeholder="Nomor Induk Karyawan" type="" class="form-control" required></div>
                                                </div>
                                                <div class="col-md-12">
